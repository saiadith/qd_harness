...
![recovery curve](images/recovery_curve.png)
...
![per-layer quantization error](images/per_layer_quantization_error.png)
...
![weight distribution shift](images/weight_distribution_shift.png)
...
![quality gate outcome](images/quality_gate_outcome.png)
...
![speculative decoding tradeoff](images/speculative_decoding_tradeoff.png)
...
![draft acceptance rate by precision](images/draft_acceptance_rate.png)
